...
<body style="background-color: #2D68C4">
    <br>
    <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h2 style="text-align:center">CSEARCHIVE REGISTER PAGE</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="register">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="telephone" value="{{ old('telephone') }}" required autocomplete="phone" autofocus>
