                                ...
                                <div class="form-validation">
                                    ...
                                    @if(Session::get('Success'))
                                        ...
                                        <form method="POST" action="{{ route('budgets.store') }}">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="amount">Amount To Spend:</label>
                                                <div class="col-lg-6">
                                                <input class="form-control" type="number" name="budget_amount" id="amount" step="0.01" required> 
                                                </div> 
                                            </div>
