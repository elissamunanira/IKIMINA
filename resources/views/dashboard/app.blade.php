...
<head>
    ...
    <!-- Styles -->
    <link href="/dashbboard/css/lib/calendar2/pignose.calendar.min.css" rel="stylesheet">
    <link href="/dashbboard/css/lib/chartist/chartist.min.css" rel="stylesheet">
    <link href="/dashbboard/css/lib/font-awesome.min.css" rel="stylesheet">
    <link href="/dashbboard/css/lib/themify-icons.css" rel="stylesheet">
    <link href="/dashbboard/css/lib/owl.carousel.min.css" rel="stylesheet" />
    <link href="/dashbboard/css/lib/owl.theme.default.min.css" rel="stylesheet" />
    <link href="/dashbboard/css/lib/weather-icons.css" rel="stylesheet" />
    <link href="/dashbboard/css/lib/menubar/sidebar.css" rel="stylesheet">
    <link href="/dashbboard/css/lib/bootstrap.min.css" rel="stylesheet">
    <link href="/dashbboard/css/lib/helper.css" rel="stylesheet">
    <link href="/dashbboard/css/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <!-- jquery vendor -->
    <script src="/dashbboard/js/lib/jquery.min.js"></script>
    <script src="/dashbboard/js/lib/jquery.nanoscroller.min.js"></script>
    <!-- nano scroller -->
    <script src="/dashbboard/js/lib/menubar/sidebar.js"></script>
    <script src="/dashbboard/js/lib/preloader/pace.min.js"></script>
    <!-- sidebar -->

    <script src="/dashbboard/js/lib/bootstrap.min.js"></script>
    <script src="/dashbboard/js/scripts.js"></script>
    <!-- bootstrap -->

    <script src="/dashbboard/js/lib/calendar-2/moment.latest.min.js"></script>
    <script src="/dashbboard/js/lib/calendar-2/pignose.calendar.min.js"></script>
    <script src="/dashbboard/js/lib/calendar-2/pignose.init.js"></script>


    <script src="/dashbboard/js/lib/weather/jquery.simpleWeather.min.js"></script>
    <script src="/dashbboard/js/lib/weather/weather-init.js"></script>
    <script src="/dashbboard/js/lib/circle-progress/circle-progress.min.js"></script>
    <script src="/dashbboard/js/lib/circle-progress/circle-progress-init.js"></script>
    <script src="/dashbboard/js/lib/chartist/chartist.min.js"></script>
    <script src="/dashbboard/js/lib/sparklinechart/jquery.sparkline.min.js"></script>
    <script src="/dashbboard/js/lib/sparklinechart/sparkline.init.js"></script>
    <script src="/dashbboard/js/lib/owl-carousel/owl.carousel.min.js"></script>
    <script src="/dashbboard/js/lib/owl-carousel/owl.carousel-init.js"></script>
    <!-- scripit init-->
    <script src="/dashbboard/js/dashboard2.js"></script>
</body>
